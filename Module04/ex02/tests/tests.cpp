...
/*   Updated: 2022/12/11 22:23:08 by wismith          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
 *	@ Default_test_abstract brief
 * 		test created by wismith
 *
 *		Tests if instantiation is possible
 *			of course it isn't! So I had to
 *				comment the test out!
 */

// void Default_test_abstract()
// {
// 	std::cout << "Default_abstract Test: "  << std::endl << std::endl;
// 	std::cout << "\tTest if Animal class is instantiable \x1B[32m" << std::endl << std::endl;
// 	{
// 		//! Constructing
...
{
	std::cout << "Test Abstract one: "  << std::endl << std::endl;
	std::cout << "\tTest if Cat and Dog still work \x1B[32m" << std::endl << std::endl;
	{
		//! Constructing
